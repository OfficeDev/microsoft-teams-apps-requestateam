...
.PARAMETER Location
    Azure region to deploy the resources to (see below - internal name should be used e.g. uksouth.
...
function ValidateAzureLocation {
    ...
    -or ($global:location -eq "francesouth") -or ($global:location -eq "westindia") -or ($global:location -eq "japaneast") -or ($global:location -eq "koreasouth") -or ($global:location -eq "switzerlandnorth") -or ($global:location -eq "switzerlandnwest") -or ($global:location -eq "uaecentral") -or ($global:location -eq "uaenorth") -or ($global:location -eq "ukwest") `
    -or ($global:location -eq "norwayeast") -or ($global:location -eq "norwaywest") -or ($global:location -eq "germanywestcentral")) {
